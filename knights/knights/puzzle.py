...
knowledge1 = And(
    ...
    Or(And(AKnight,And(AKnave,BKnave)), And(AKnave,BKnight))
)
...
knowledge2 = And(
    ...
    Or(And(BKnight,Or(And(AKnight,Not(BKnight)),And(AKnave,Not(BKnave)))),And(BKnave,Not(Or(And(AKnight,Not(BKnight)),And(AKnave,Not(BKnave))))))
)
...
knowledge3 = And(
    ...
    Or(AKnight,And(AKnave,Not(AKnave))),
